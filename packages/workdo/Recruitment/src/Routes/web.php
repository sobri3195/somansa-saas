...
Route::middleware(['web', 'auth', 'verified', 'PlanModuleCheck:Recruitment'])->group(function () {
    Route::get('/recruitment', [RecruitmentDashboardController::class, 'index'])->name('recruitment.index');
    Route::get('/recruitment/dashboard', [RecruitmentDashboardController::class, 'index'])->name('recruitment.dashboard');

    Route::prefix('recruitment/job-categories')->name('recruitment.job-categories.')->group(function () {
