                ...
                <div className="flex items-center gap-1 min-w-fit">
                    <TooltipProvider>
                        {auth.user?.permissions?.includes('send-offer-emails') && (
                            <Tooltip delayDuration={0}>
                                <TooltipTrigger asChild>
                                    <Button variant="ghost" size="sm" onClick={() => handleSendEmail(offer.id)} className="h-8 w-8 p-0 text-orange-600 hover:text-orange-700 hover:bg-orange-50">
                        ...
                        {offer.status === '2' && auth.user?.permissions?.includes('download-offer-letters') && (
                            <Tooltip delayDuration={0}>
                                <TooltipTrigger asChild>
                                    <Button variant="ghost" size="sm" onClick={() => window.open(offer.download_url, '_blank')} className="h-8 w-8 p-0 text-purple-600 hover:text-purple-700 hover:bg-purple-50">
                        ...
                        {offer.status === '2' && !Boolean(offer.converted_to_employee) && auth.user?.permissions?.includes('convert-offers-to-employees') && (
                            <Tooltip delayDuration={0}>
                                <TooltipTrigger asChild>
                                    <Button variant="ghost" size="sm" onClick={() => router.get(route('recruitment.offers.convert-to-employee', offer.id))} className="h-8 w-8 p-0 text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50">
                        ...
                        {Boolean(offer.converted_to_employee) && offer.employee_id && auth.user?.permissions?.includes('view-offer-employees') && (
                            <Tooltip delayDuration={0}>
                                <TooltipTrigger asChild>
                                    <Button variant="ghost" size="sm" onClick={() => router.get(route('hrm.employees.show', offer.employee_id))} className="h-8 w-8 p-0 text-indigo-600 hover:text-indigo-700 hover:bg-indigo-50">
                        ...
                        {auth.user?.permissions?.includes('view-offers') && (
                            <Tooltip delayDuration={0}>
                                <TooltipTrigger asChild>
                                    <Button variant="ghost" size="sm" onClick={() => setViewingItem(offer)} className="h-8 w-8 p-0 text-green-600 hover:text-green-700 hover:bg-green-50">
                        ...
                        {auth.user?.permissions?.includes('edit-offers') && (
                            <Tooltip delayDuration={0}>
                                <TooltipTrigger asChild>
                                    <Button variant="ghost" size="sm" onClick={() => openModal('edit', offer)} className="h-8 w-8 p-0 text-blue-600 hover:text-blue-700 hover:bg-blue-50">
                                                        ...
                                                        <TooltipProvider>
                                                            {auth.user?.permissions?.includes('send-offer-emails') && (
                                                                <Tooltip delayDuration={300}>
                                                                    <TooltipTrigger asChild>
                                                                        <Button variant="ghost" size="sm" onClick={() => handleSendEmail(offer.id)} className="h-9 w-9 p-0 text-orange-600 hover:text-orange-700 hover:bg-orange-50">
                                                                            <Mail className="h-4 w-4" />
                                                                        </Button>
                                                                    </TooltipTrigger>
                                                                    <TooltipContent>
                                                            ...
                                                            {offer.status === '2' && auth.user?.permissions?.includes('download-offer-letters') && (
                                                                <Tooltip delayDuration={300}>
                                                                    <TooltipTrigger asChild>
                                                                        <Button variant="ghost" size="sm" onClick={() => window.open(offer.download_url, '_blank')} className="h-9 w-9 p-0 text-purple-600 hover:text-purple-700 hover:bg-purple-50">
                                                                            <Download className="h-4 w-4" />
                                                                        </Button>
                                                                    </TooltipTrigger>
                                                                    <TooltipContent>
                                                            ...
                                                            {offer.status === '2' && !Boolean(offer.converted_to_employee) && auth.user?.permissions?.includes('convert-offers-to-employees') && (
                                                                <Tooltip delayDuration={300}>
                                                                    <TooltipTrigger asChild>
                                                                        <Button variant="ghost" size="sm" onClick={() => router.get(route('recruitment.offers.convert-to-employee', offer.id))} className="h-9 w-9 p-0 text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50">
                                                                            <UserPlus className="h-4 w-4" />
                                                                        </Button>
                                                                    </TooltipTrigger>
                                                                    <TooltipContent>
                                                            ...
                                                            {Boolean(offer.converted_to_employee) && offer.employee_id && auth.user?.permissions?.includes('view-offer-employees') && (
                                                                <Tooltip delayDuration={300}>
                                                                    <TooltipTrigger asChild>
                                                                        <Button variant="ghost" size="sm" onClick={() => router.get(route('hrm.employees.show', offer.employee_id))} className="h-9 w-9 p-0 text-indigo-600 hover:text-indigo-700 hover:bg-indigo-50">
                                                                            <User className="h-4 w-4" />
                                                                        </Button>
                                                                    </TooltipTrigger>
                                                                    <TooltipContent>
                                                            ...
                                                            {auth.user?.permissions?.includes('view-offers') && (
                                                                <Tooltip delayDuration={300}>
                                                                    <TooltipTrigger asChild>
                                                                        <Button variant="ghost" size="sm" onClick={() => setViewingItem(offer)} className="h-9 w-9 p-0 text-green-600 hover:text-green-700 hover:bg-green-50">
                                                                            <Eye className="h-4 w-4" />
                                                                        </Button>
                                                                    </TooltipTrigger>
                                                                    <TooltipContent>
                                                            ...
                                                            {auth.user?.permissions?.includes('edit-offers') && (
                                                                <Tooltip delayDuration={300}>
                                                                    <TooltipTrigger asChild>
                                                                        <Button variant="ghost" size="sm" onClick={() => openModal('edit', offer)} className="h-9 w-9 p-0 text-blue-600 hover:text-blue-700 hover:bg-blue-50">
                                                                            <EditIcon className="h-4 w-4" />
                                                                        </Button>
                                                                    </TooltipTrigger>
                                                                    <TooltipContent>
