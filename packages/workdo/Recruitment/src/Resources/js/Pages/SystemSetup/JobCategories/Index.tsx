...
export default function Index() {
    ...
    const { jobcategories, auth } = usePage<JobCategoriesIndexProps>().props;
                        ...
                        {auth.user?.permissions?.includes('edit-job-categories') && (
                            <Tooltip delayDuration={0}>
                                <TooltipTrigger asChild>
                                    <Button variant="ghost" size="sm" onClick={() => openModal('edit', jobcategory)} className="h-8 w-8 p-0 text-blue-600 hover:text-blue-700">
                                    ...
                                    <div className="min-w-[600px]">
                                        <DataTable
                                            ...
                                            emptyState={
                                                <NoRecordsFound
                                                    icon={Tag}
                                                    title={t('No Job Categories found')}
                                                    description={t('Get started by creating your first Job Category.')}
                                                    createPermission="create-job-categories"
                                                    onCreateClick={() => openModal('add')}
                                                    createButtonText={t('Create Job Category')}
                                                    className="h-auto"
                                                />
                                            }
                                        />
