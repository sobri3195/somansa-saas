...
class PermissionTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $permission = [
            ...
            ['name' => 'manage-job-categories', 'module' => 'job-categories', 'label' => 'Manage Job Categories'],
            ['name' => 'manage-any-job-categories', 'module' => 'job-categories', 'label' => 'Manage All Job Categories'],
            ['name' => 'manage-own-job-categories', 'module' => 'job-categories', 'label' => 'Manage Own Job Categories'],
            ['name' => 'create-job-categories', 'module' => 'job-categories', 'label' => 'Create Job Categories'],
            ['name' => 'edit-job-categories', 'module' => 'job-categories', 'label' => 'Edit Job Categories'],
            ['name' => 'delete-job-categories', 'module' => 'job-categories', 'label' => 'Delete Job Categories'],
